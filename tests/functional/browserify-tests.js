    ...
    registerSuite({
        ...
        'wiki title does not equal undefined': function () {
            return this.get('remote')
                .get(require.toUrl('browserify/index.html'))
                .setFindTimeout(500)
...
//        // FAILED on Safari 6.5 on MAC
        'added comment shows the comment added': function () {
            ...
            return remote.get(require.toUrl('browserify/index.html')).setFindTimeout(2000)
        ...
        'typing text to filter box accurately changes number of comments shown': function () {
            var remote = this.get('remote');
            return remote.get(require.toUrl('browserify/index.html'))
                .setFindTimeout(2000)
                .findById('cm-comment')
                .pressKeys('PAGE_DOWN')
                .end()
